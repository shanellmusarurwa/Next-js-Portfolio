  ...
  return (
    <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        <div className="w-45 sm:w-80 rounded-3xl max-w-none">
          <Image
            src="/mitchelle.jpg"
            alt="user"
            width={300}
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I'm a passionate frontend developer with a love for creating dynamic
            and user-friendly web applications. With a strong foundation in
            front-end technologies and a keen eye for design, I strive to
